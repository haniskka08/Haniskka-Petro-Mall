...
\restrict SktqZXy5N3PK6eIwEdMKildwrADzzKoVXyai45Om1DC74QFu1yLRSpITQwz5siH

-- Dumped from database version 17.10
-- Dumped by pg_dump version 17.10

-- Started on 2026-06-21 11:04:29
...
--
-- TOC entry 5016 (class 0 OID 16396)
-- Dependencies: 217
...
--
-- TOC entry 5030 (class 0 OID 16567)
-- Dependencies: 231
-- Data for Name: brand_categories; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.brand_categories (id, name, created_at, updated_at) FROM stdin;
\.
...
-- Dependencies: 233
-- Data for Name: brand_requirements; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.brand_requirements (id, brand_user_id, category_id, radius_km, min_area_sqft, max_area_sqft, status, created_at, updated_at) FROM stdin;
\.


--
-- TOC entry 5018 (class 0 OID 16402)
-- Dependencies: 219
-- Data for Name: dealers; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.dealers (id, full_name, email, phone, company_name, hashed_password, address, is_active, created_at, updated_at) FROM stdin;
2	Haniskka	haniskka@gmail.com	9944296441	ABC pvt ltd.	$2b$12$.6ZFnZNY/YnOJG8HhdRUsOeRXZzuJYnAZU25e/MJbsu2dJmsOJh8O	\N	t	2026-06-06 21:54:47.648611+05:30	2026-06-06 21:54:47.648611+05:30
1	 User	testuser@example.com	9234567890	Test Co	$2b$12$sily3WU6lhyR.HPjxWHNuOl/M1Jk7qaDc/7IbOVgi6huPvN0aQ3fW		t	2026-06-06 18:28:19.166742+05:30	2026-06-14 12:06:17.121994+05:30
\.


--
-- TOC entry 5034 (class 0 OID 16601)
-- Dependencies: 235
-- Data for Name: matches; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.matches (id, space_id, requirement_id, status, reviewed_by, created_at, updated_at) FROM stdin;
\.
...
-- Dependencies: 223
-- Data for Name: preferred_brands; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.preferred_brands (id, station_id, brand_name, brand_category, created_at, updated_at, category_id) FROM stdin;
1	1	Starbucks	Coffee & Beverages	2026-06-14 09:51:45.462513+05:30	2026-06-14 09:51:45.462513+05:30	\N
2	1	Café Coffee Day	Coffee & Beverages	2026-06-14 09:51:48.47376+05:30	2026-06-14 09:51:48.47376+05:30	\N
3	1	Axis Bank ATM	Banking	2026-06-14 09:51:50.507504+05:30	2026-06-14 09:51:50.507504+05:30	\N
4	1	Apollo Pharmacy	Healthcare	2026-06-14 09:51:52.238406+05:30	2026-06-14 09:51:52.238406+05:30	\N
5	1	MedPlus	Healthcare	2026-06-14 09:51:54.84899+05:30	2026-06-14 09:51:54.84899+05:30	\N
9	4	Starbucks	Coffee & Beverages	2026-06-16 21:47:28.840945+05:30	2026-06-16 21:47:28.840945+05:30	\N
10	4	KFC	Fast Food	2026-06-16 21:47:29.922115+05:30	2026-06-16 21:47:29.922115+05:30	\N
11	4	Café Coffee Day	Coffee & Beverages	2026-06-16 21:47:31.015802+05:30	2026-06-16 21:47:31.015802+05:30	\N
12	4	Subway	Fast Food	2026-06-16 21:47:32.055795+05:30	2026-06-16 21:47:32.055795+05:30	\N
13	4	Domino's	Fast Food	2026-06-16 21:47:33.549202+05:30	2026-06-16 21:47:33.549202+05:30	\N
14	4	McDonald's	Fast Food	2026-06-16 21:47:36.330553+05:30	2026-06-16 21:47:36.330553+05:30	\N
\.
...
COPY public.spaces (id, station_id, name, space_type, area_sqft, monthly_rent, availability_status, created_at, updated_at, power_kw, water_available, drainage_avail) FROM stdin;
1	1	Sample space	retail	200	5000	available	2026-06-14 11:49:16.267219+05:30	2026-06-14 11:49:16.267219+05:30	\N	f	f
3	4	ABC Squares	food_court	654	7800	available	2026-06-16 21:47:13.94794+05:30	2026-06-16 21:47:13.94794+05:30	\N	f	f
\.


--
-- TOC entry 5026 (class 0 OID 16465)
-- Dependencies: 227
-- Data for Name: station_images; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.station_images (id, station_id, file_name, file_path, file_size, mime_type, created_at, updated_at) FROM stdin;
1	1	OIP.jpg	uploads\\1\\0cc1e2561d8f41ff9319bc217e35cf55.jpg	5315	image/jpeg	2026-06-14 11:48:26.717124+05:30	2026-06-14 11:48:26.717124+05:30
\.


--
-- TOC entry 5028 (class 0 OID 16483)
-- Dependencies: 229
-- Data for Name: station_utilities; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.station_utilities (id, station_id, electricity, water, internet, parking, washroom, cctv, created_at, updated_at) FROM stdin;
1	1	t	t	f	t	t	t	2026-06-14 09:51:40.440034+05:30	2026-06-14 09:51:40.440034+05:30
\.
...
COPY public.stations (id, dealer_id, name, address, city, state, pincode, latitude, longitude, contact_number, description, created_at, updated_at, status) FROM stdin;
1	1	Hindustan Petroleum	333,Cross cut road ,Gandhipuram	Coimbatore	Tamil Nadu	641012	10.944832	76.84815	9443803145		2026-06-14 09:50:59.402078+05:30	2026-06-16 21:13:10.166352+05:30	pending
4	1	Radha Agencies (Bharat Petroleum)	75, Near Valluvar Gurukulam, Gst Road, Tambaram	Chennai	Tamil Nadu	600045	12.928906	80.114404			2026-06-16 21:37:04.250824+05:30	2026-06-16 21:37:04.250824+05:30	pending
\.
...
-- Dependencies: 232
-- Name: brand_requirements_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.brand_requirements_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.dealers_id_seq', 2, true);
...
-- Dependencies: 222
-- Name: preferred_brands_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.preferred_brands_id_seq', 14, true);
...
-- Dependencies: 226
-- Name: station_images_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.station_images_id_seq', 3, true);


--
-- TOC entry 5056 (class 0 OID 0)
-- Dependencies: 228
-- Name: station_utilities_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.station_utilities_id_seq', 2, true);
...
-- Completed on 2026-06-21 11:04:29

--
-- PostgreSQL database dump complete
--

\unrestrict SktqZXy5N3PK6eIwEdMKildwrADzzKoVXyai45Om1DC74QFu1yLRSpITQwz5siH
